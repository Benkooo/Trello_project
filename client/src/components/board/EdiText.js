...
export default class EditableLabelOR extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        console.log("FONTSIZE:", this.props.labelFontSize);
        return <div style={{marginTop: this.props.titleMarginTop}}>
